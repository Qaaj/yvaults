...
function App() {
  ...
  useEffect( () => {
    const loadDeps = async () => {
      const yearn = fromFile(mockJSON);
      const pricePerFullShare = await yearn.VaultContract.getPricePerFullShare();
      setData(pricePerFullShare/1e18)
